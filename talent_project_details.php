...
<!---black strip------->
        ...
        <div style="float:left; font-size:13px; color:#ccc; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:30px; padding-left:10px;"><a style="font-decoration:none;color:#ccc;" href="talent_project.php?talent_id=<?=$_REQUEST['talent_id']?>">Projects</a> > <?=$fatch76['project_title']?></div>
