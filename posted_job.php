		...
		<?include('top.php');?> 
			<div>
				<div class="main_body_area">
					...
					$job_list = "select * from fs_job where company_id = '".$_SESSION['fab_id']."' AND status = 1 ".$limit2."" ;
					     $job_run = q($job_list);
						...
						<table class="center_body" width="100%"  border="0" align="center" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right;">
							...
							<tr>
                                ...
                                <div class="jobs_tabing">
                                	<ul>
                                    	<li><a href="posted_job.php?tab=1" class="active">Jobs</a></li>
                                        <li><a href="posted_audition.php?tab=1" >Auditions</a></li>
                                    </ul>
                                </div>
                                </td>
                            </tr>
							...
							<tr>
								...
								<!-- <td width="3%"></td><td width="60%" >
								
								<a style="text-decoration:none;color:#603F3F;" href="view_profile.php?id=<?=$job_fatch['fld_id']?>"><?=$job_fatch['title']?> </a>
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
                        <td>
							...
							?>
                             <h1><a href="view_profile.php?id=<?=$job_fatch['fld_id']?>"><?=$job_fatch['title']?></a></h1>
										<table width="100%" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
										  <tr>
											...
											<?}?>
											<td valign="top" class="talent_result"><h1><a href="view_profile.php?id=<?=$job_fatch['fld_id']?>"><?=$fatch_company_info['name']?></a></h1>
							...
							<!--------------->
								 ...
								 <td width="30%">
								 <!-- <a href="view_profile.php?id=<?=$job_fatch['fld_id']?>">[<?=$job_number1?>]</a> -->
								 
								 
								  <a href="view_profile.php?id=<?=$job_fatch['fld_id']?>">Applied Talent :</a> <strong><a href="view_profile.php?id=<?=$job_fatch['fld_id']?>">[<?=$job_number1?>]</a></strong>
                           ...
                           <tr >
                                  <td colspan="3" align="center" height="10px" style="color: #B00000">
                                            <?
                                             $sqlag = "select * from fs_job where company_id = '".$_SESSION['fab_id']."' AND status = 1";
                                       
                                                $rescs = q($sqlag);
                                                 $countcs = nr($rescs);
                                                if($countcs >5){
                                                    doPages(5, 'posted_job.php', '', $countcs); 
                                                }
                                            ?>
                                   </td>
                           </tr>
