...
define('MF_MYSQL_HOST', 'https://sg2nlsmysqladm1.secureserver.net/grid50/449');
define('MF_MYSQL_USER', 'fabother');
define('MF_MYSQL_PASS', 'Cx@hKLJ2Xz%!');
