						...
						<table class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="float:right; margin-top:0px;">
                        	<tr>
                                ...
                                <div class="jobs_tabing">
                                	<ul>
                                    	<li><a href="applied_jobs_list.php?tab=3" class="active">Jobs</a></li>
                                        <li><a href="applied_audition_list.php?tab=3" >Auditions</a></li>
                                    </ul>
                                </div>
                                </td>
                            </tr>
                         ...
                         if($_REQUEST['page'] == '' || $_REQUEST['page'] == 1){
                            ...
                            $limit2 = "ORDER BY fld_id DESC LIMIT ".$off.",".$value." ";
									...
									$job_query = q("SELECT * FROM fs_applied_job WHERE talent_id='".$_SESSION['fab_id']."' AND status=1 ".$limit2."");
   ...
   <td width="5%"></td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
                          <tr>
							...
							<td valign="top" width="70"><img src="<?=$fatch_company_info['profile_crop_image']?>" width="50" height="50" /></td>
                             <?}else{?>
                            <td valign="top" width="70"><img src="newhome/images/images.jpg" width="50" height="50" /></td>
                            <?}?>
                            ...
                            <tr >
                                  <td colspan="3" align="center" height="10px" style="color: #B00000">
                                            <?
                                             $sqlag = "SELECT * FROM fs_applied_job WHERE talent_id='".$_SESSION['fab_id']."' AND status=1";
                                       
                                                $rescs = q($sqlag);
                                                 $countcs = nr($rescs);
                                                if($countcs >5){
                                                    doPages(5, 'applied_jobs.php', '', $countcs); 
                                                }
                                            ?>
                                   </td>
                           </tr>
