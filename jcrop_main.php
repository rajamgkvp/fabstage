		  ...
		  <tr>
            ...
            <div style="margin-bottom:10px;">
                ...
                <div style="overflow: hidden; width: 200px; height: 200px;">
                    <img id="preview" src="http://fs.sitebysite.us/<?=$_REQUEST['link']?>"/>
                </div>
             </td>
			 ...
			 <td width="50%" action="center">
                ...
                <div style="overflow: hidden; width: 200px; height: 200px;">
                   <img  src="http://fs.sitebysite.us/example13/files/games/<?=$_SESSION['fab_id']?>_tb.jpg"/>
                </div> 
             </td>
		   ...
		   <tr>
		     <td>
                <img src="http://fs.sitebysite.us/<?=$_REQUEST['link']?>" id="cropbox1"/>
