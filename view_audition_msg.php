...
<html>
	<body>
	   <div style="background:#669966; padding:5px;"> 
		...
		<?php
		   $title_query11 = q("SELECT * FROM  fs_audition_msg WHERE (sender_id='".$_SESSION['fab_id']."' OR sender_id='".$_REQUEST['talent_id']."') AND (receiver_id='".$_SESSION['fab_id']."' OR receiver_id='".$_REQUEST['talent_id']."') AND audition_id = '".$_REQUEST['audition_id']."' order by fld_id DESC ");
		?>
