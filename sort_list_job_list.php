...
function reject(j_id,t_id){
 ...
 if(retVal == true ){
          window.location.href="delete_job_details.php?jobid="+j_id+"&talentid="+t_id;
         return true;
 }else{
			//alert("Thank You");
			return false;
						...
						<table class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="float:right; margin-top:0px;">
							<tr>
                                ...
                                <div class="jobs_tabing">
                                	<ul>
                                    	<li><a href="sort_list_job_list.php?tab=5" class="active">Job </a></li>
                                        <li><a href="sort_list_audition_list.php?tab=5" >Audition </a></li>
                                    </ul>
                                </div>
                               </td>
                            </tr>
								 ...
								 <?if($_REQUEST['delete']!=''){?>
								  <tr>
								    <td>
									   ...
									   Job Rejected and Deleted Successfully...
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
                          <tr>
							...
							<!--------------->
                                ...
                                <div class="reject_btn"><div class="accept_btn"><a href="#" onclick="reject(<?=$job_result['job_id']?>,<?=$job_result['talent_id']?>);" >Reject</a></div> <a href="#" onclick="getConfirmation(<?=$job_result['job_id']?>,<?=$job_result['talent_id']?>);">Accept</a></div>
								...
								<!-- <a>
										<?if($job_result['status']==2) {?>
											<input type="button" name="ibtn" class = "button" value="Intrested ?" onclick="getConfirmation(<?=$job_result['job_id']?>,<?=$job_result['talent_id']?>);">
										<?}?>
								</a> -->
