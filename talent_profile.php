    	...
    	<div class="profile_body">
        	<div class="profile_left_area">
                ...
                <ul>
                    ...
                    <li><a href="talent_gallery.php?talent_id=<?=$_REQUEST['talent_id']?>">Gallery</a></li>
                    <li><a href="talent_project.php?talent_id=<?=$_REQUEST['talent_id']?>">Work History</a></li>
                    ...
                    <div class="subscribe_btn_area" style="width:220px;">
					 ...
					 ?>
                    	 <!-- <div class="subscribe"><a href="#">+Select</a></div> -->
							...
							echo  "This Talent is already in a list for selected  role. ";	
							}?>
							</div>
							<ul class="loginBtn">
                                    <li class="first-tab select-box" style="width:99px;">
									<select class="search1" title="Select one" id="selectbox" name="selectbox" onchange="javascript:if(confirm('Are you sure to select this talent for selected role?'))location.href = this.value;">
							           ...
							           ?>
										<option value="select_for_job.php?job_id=<?=$ftc['fld_id']?>&talent_id=<?=$_REQUEST['talent_id']?>&company_id=<?=$_SESSION['fab_id']?>&type=1"><?=$ftc['title']?></option>
                                        <?}?>
									   </optgroup>
									   <optgroup label=""></optgroup>
                                       ...
                                       $j_list = q("select * from  fs_oudition where company_id = ".$_SESSION['fab_id']."");
										while($ftcc = f($j_list)){?>
                                         ...
                                         <option value="select_for_job.php?audition_id=<?=$ftcc['fld_id']?>&talent_id=<?=$_REQUEST['talent_id']?>&company_id=<?=$_SESSION['fab_id']?>&type=2"><?=$ftcc['title']?>
										 </option>
...
<script type="text/javascript" src="js/amazon_scroller.js"></script>
        ...
        <script language="javascript" type="text/javascript">
        	...
        	<div id="amazon_scroller3" class="amazon_scroller">
				  ...
				  $png = ".png";
				  $gif = ".gif";
				  $select_image = "select * from fs_talent_portfolio where talent_id='".$id."'  AND (portfolio_data LIKE '%".$jpg."%' OR portfolio_data LIKE '%".$png."%' OR portfolio_data LIKE '%".$gif."%') AND portfolio_data!='' ";
