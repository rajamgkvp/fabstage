					 ...
					 <?include('left_work_room.php');?>
						...
						<tr>
                                ...
                                <div class="jobs_tabing">
                                	<ul>
                                    	<li><a href="match_job_list.php?tab=1" class="active">Jobs</a></li>
                                        <li><a href="match_audition_list.php?tab=1" >Auditions</a></li>
                                    </ul>
                                </div>
                                </td>
                            </tr>
					...
					<tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="clear:both;">
                          <tr>
							...
							<?
						   $sql_apply = q("select * from fs_applied_job where talent_id = '".$_SESSION['fab_id']."' AND job_id = '".$qls_fatch['fld_id']."'");
