...
$id = $_SESSION['fab_id'];
	  ...
	  if($_REQUEST['submit']!=""){
			...
			$sql1 = "update fs_talent_portfolio set skill='".$check_val."',video='".$_REQUEST['video_link']."' where skill = '' ";
...
require_once "portfolio_uploader/phpuploader/include_phpuploader.php"; 
?>
			     ...
			     <tr>
					...
					<td>
					  	 <?php
								...
								$uploader->SaveDirectory="portfolio_uploader/savefiles";
