<?php 
    ...
    if($_REQUEST['submit']!="")
	{
	     ...
	     $update_r = "UPDATE fs_talent_project SET skill = '".$check_val."',project_title = '".$_REQUEST['pro_title']."',month_year = '".$_REQUEST['month']."',description = '".$_REQUEST['des']."' Where talent_id = '".$id."' AND fld_id = '".$_REQUEST['id']."' ";
         $update_run = q($update_r);

	

           header('location:project_details.php?id='.$_REQUEST['id'].'');
	...
	<body class="overlay-nav">
        ...
        <div style="float:left; font-size:13px; color:#ccc; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:30px; padding-left:10px;"><a style="font-decoration:none;color:#ccc;" href="project.php">Projects</a> > <a style="font-decoration:none;color:#ccc;" href="project_details.php?id=<?=$_REQUEST['id']?>"><?=ucfirst($fatch11['project_title'])?></a> > <a style="font-decoration:none;color:#ccc;" href="">Add Project Files</a> </div>
				...
				<div class="center_body" style="width:820px;">
					...
					<table class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right; width:635px;">
			...
			while($fatch = f($res)){ 
			   ...
			   $main_skill = str_replace(',,',',', $skill);
				...
				<table width="100%"  border="0" align="center" cellspacing="0" cellpadding="0">
                    ...
                    <tr><td colspan="3" style="font-size:22px; text-align:center; color:#4FBFE3; border-bottom:1px #ccc solid; line-height:35px; font-weight:bold;">Edit projects</td></tr>
					...
					<?foreach ($skill as &$value) {
						...
						<td  align="left" align="left" style="font-size: 12px; color: #999; padding-top: 5px; line-height:13px; font-family: Arial, Helvetica, sans-serif;"><input style="float: left; margin-right: 5px; width:auto;" type="checkbox" name="cat[]" id="cat[]" value="<?=$value?>" <?if(strpos($fatch11['skill'],$value)){?>checked<?}?>> <?=$value?> </td>
