...
function edit_news(id){
	...
	window.open('edit_project_front.php?id='+id,'',winparam);
}
</script>
</head>
<script>
...
<tr>
  ...
  <tr>
    <td colspan="2" style="padding-left:210px;" class="text_heading"> Project Summary:   </td>
  </tr>
  ...
  <tr>
    <td colspan="2" height="8">
		 ...
		 <form enctype="multipart/form-data" onSubmit="return validate();" name="upload_form" id="upload_form" action="" method="POST"  autocomplete="on" style="font:normal 13px arial;">
					<table
 class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right;">
