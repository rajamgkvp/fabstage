...
<form enctype="multipart/form-data" name="form" id="form" action="" method="POST" >
	<div class="post_area">
		<ul>
			...
			<li>
				<a>Nationality: 
					&nbsp;<input value="<?=$_REQUEST['nationality']?>" type="text" name="nationality" id="nationality">
				</a>
			</li> 
			<li>
