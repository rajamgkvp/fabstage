            ...
            <li>
				<a>Job Type: 
					<select id="job_type" name="job_type">
					  ...
					  <option value="regular" <?if($_REQUEST['job_type']=="regular"){?>selected<?}?>>Regular</option>
					  <option value="contractual" <?if($_REQUEST['job_type']=="contractual"){?>selected<?}?>>Contractual</option>
					</select>
				</a>
			</li>
