...
if($_REQUEST['submit']!=''){
 ...
 header('location:company_search_result.php?cat='.$_REQUEST['cat'].'&category='.$_REQUEST['category'].'&location='.$_REQUEST['location'].'&to_experience='.$_REQUEST['to_experience'].'&from_experience='.$_REQUEST['from_experience'].'&assosiation_name='.$_REQUEST['assosiation_name'].'');
