		...
		<?php
			...
			while($fatch = f($res)){ 
				...
				<table width="100%"  border="0" align="center" cellspacing="0" cellpadding="0">
				                      	...
				                      	<tr>
											 <td class="text_heading" align="left"><a href="#" onclick="javascript:if(document.getElementById('<?="r".$k;?>').style.display=='none') document.getElementById('<?="r".$k;?>').style.display='block';else if(document.getElementById('<?="r".$k;?>').style.display=='block') document.getElementById('<?="r".$k;?>').style.display='none';"><?=$fatch['category_name']?></a>  
											 </td>
										</tr>
