...
function edit_news(id){
	winparam = 'width=600,height=350,scrollbars=1,left=340,top=60,screenX=300,screenY=120';
	window.open('edit_company_project.php?id='+id,'',winparam);
}
</script>
</head>
<script>
...
function delete_pub(id){
	...
	window.location.href='delete_project_front.php?id='+id+'&pro_id=<?=$id?>';
}
			  ...
			  <tr>
			    ...
			    <tr>
					...
					<td>
                       ...
                       <textarea id="video_link" name="video_link" cols="47" rows="2"></textarea><br>
    ...
    <td colspan="2" height="8" width="100%">
		<table cellpadding="1" cellspacing="1" width="100%">
		   <tr style="background-color: #669966">
			  ...
			  <?
				$sqlg = "Select * from fs_company_project Where company_id = '".$id."' order by fld_id DESC";
				$resg = q($sqlg);
				$countg = nr($resg);
				if($countg){
					while($rowg = f($resg)){
			  ...
			  <tr>
					...
					<td><a href="#" onClick="javascript:delete_pub(<?=$rowg['fld_id']?>)"><img src="admin/admin_img/delete.png" border="0"></a></td>
			  </tr>	
			<?		}
				}else{?>
				<tr>
