<? include('constants.php');
   ...
   if(isset($_REQUEST['submit'])){
	                ...
	                $run=q($query);
					if($run){
					   header('Location: http://fs.sitebysite.us/company_step3.php');
					}
							...
							<tr>
							  ...
							  <tr>
							   ...
							   <tr>
								...
								<td><input class="input"   name="association_name" value="<?=$quer_fatch['association_name']?>" <?if($quer_fatch['any_association']=="yes"){?><?}else{?>disabled<?}?> type="text" id="association_name" size="30" ></td>
						    </tr> 
