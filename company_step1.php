...
if(isset($_REQUEST['submit'])){
				   ...
				   for($j=0;$j<count($_REQUEST['cat']);$j++)
					...
					$query = "insert into fs_company(member_id, 	main_skill,other1,other2,other3,other4,added_on)values('".$_SESSION['fab_id']."','".$check_val."','".$_REQUEST['other1']."','".$_REQUEST['other2']."','".$_REQUEST['other3']."','".$_REQUEST['other4']."','".date('Y-m-d h:i:s')."')";
	...
	<body >
	  <div style="background:#669966; padding:5px;"> 
	   ...
	   <a href="http://fs.sitebysite.us/company_step4.php" class="text">Fourth Step <span></span></a> 
		...
		<form name="upload_form" id="upload_form" action="" method="POST" onsubmit="return validate();"   autocomplete="off" style="font:normal 13px arial;">
				
				
                      <div align="center" style="color:#cc3333;"><?=$msg?></div>
