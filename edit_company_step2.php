...
if($_REQUEST['name']!= ""){	//UPLOAD LOGO
				...
				$sql = "INSERT INTO fs_company_contact (company_id, name,address,email,phone,url,  added_on) VALUES ('".$id."', '".$_REQUEST['name']."','".$_REQUEST['address']."','".$_REQUEST['email']."', '".$_REQUEST['phone']."','".$_REQUEST['url']."',  '".date('Y-m-d h:i:s')."')";
...
function edit_news(id){
	...
	window.open('edit_contact_front.php?id='+id,'',winparam);
}
</script>
...
function validate(){
	...
	if(document.upload_form.name.value == "" ){
		 errText = "- Please Enter the Contact Person Name.";
		 alert(errText);
		 errorflag = true;
...
function delete_pub(id){
	...
	window.location.href='delete_contact_front.php?id='+id+'&pro_id=<?=$id?>';
	}
}
</script>
...
<tr>
  ...
  <tr>
    <td colspan="2" align="left" class="text_heading">Add Contact Information :   </td>
  </tr>
  <tr>
    <td colspan="2" height="8">
		...
		<table cellpadding="2" cellspacing="2">
		   <tr>
			  ...
			  <tr>
					<td width="150px"><span class="style1">*</span>&nbsp;<span class="text_heading">Contact Person</span> </td>
			  ...
			  <tr>
			   ...
			   <tr>
					...
					<td><!-- <input name="address" type="text" value="" id="address" size="60" > -->
					    <textarea name="address" value="" id="address" rows="5" cols="46"></textarea>
					</td>
			  </tr>
			  <tr>
					<td colspan="2" height="8"></td>
			  ...
			  <tr>
			   ...
			   <tr>
				  <td>&nbsp;</td>
					<td>
					  <input type="submit" value="Add Contact" class="button" name="Submit">
				   </td>
				</tr>
		</table>
		<form>
  ...
  <tr>
   ...
   <tr>
    <td colspan="2" align="left"  class="text_heading">Contact List:</td>
  </tr>
   <tr>
    <td colspan="2" height="10" align="center"></td>
  </tr>
    ...
    <td colspan="2" height="8" width="100%">
		<table cellpadding="1" cellspacing="1" width="100%">
		   <tr style="background-color: #669966">
			  ...
			  <?
				$sqlg = "Select * from fs_company_contact Where company_id = '".$id."' order by fld_id DESC";
				$resg = q($sqlg);
				$countg = nr($resg);
				if($countg){
					while($rowg = f($resg)){
			  ...
			  <tr>	  
					...
					<td><a href="#" onClick="javascript:edit_news(<?=$rowg['fld_id']?>)"><img src="admin/admin_img/edit.png" border="0"></a>	  </td>
