					 ...
					 <?include('left_work_room_company.php');?>
						<table class="center_body" width="100%"  border="0" align="center" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right;">
							<tr>
							 ...
							 <?
						     $select_talent = q("select * from fs_applied_job where company_id = '".$_SESSION['fab_id']."' AND status=3 order by fld_id DESC" );
							 ...
							 $find_job_info = q("select * from fs_job where fld_id = '".$fatch_talent['job_id']."'");
