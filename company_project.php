...
function upload_multiple_file($file,$file_dir="company_project_uploader_image/savefiles/") {
 ...
 ////////////////////////////////////
            if($overwrite < 1){
			 ...
			 $file_upload_query="INSERT into fs_company_project_portfolio 
				 (
				 company_id,
				 project_id,
				 portfolio_data,
 ...
 if(isset($_FILES['files'])){
    $res =  upload_multiple_file($_FILES['files'],"company_project_uploader_image/savefiles/");
    echo $res;
    }
                  ...
                  if($_REQUEST['video_link']!=''){
								 ...
								 $video = explode(",",$video_link);
									foreach ($video as &$link) {
									   $Insert = "insert into fs_company_project_video_link(company_id,project_id,video_link,added_on)values('".$_SESSION['fab_id']."',0,'".$link."','".date('Y-m-d h:i:s')."') ";
		...
		//
           ...
           //GET LAST INSERTED ID
            ...
            $run_quer = q($update_query);              
             ...
             $update_query232 = "UPDATE fs_company_project_video_link SET project_id = '".$userid."' WHERE company_id = '".$id."' AND project_id = 0 ";
            ...
            //project_details.php?id=43
				...
				header('location:http:company_project_details.php?id='.$userid.'');
...
<?include('left_company_tab.php');?> 
	...
	<div id="content_wrap" style="z-index:100;">	
		...
		<!-- <div class="upload_btn"><a href="add_company_project.php"  title="Upload Files" rel="gb_page_center[1100, 500]">+ Add Projects</a></div>-->
		...
		<div style="float:left; clear:both;">
			...
			<div style="width:820px; float:left; margin-bottom:25px;">
				<?
				 if($_REQUEST['skill']==''){
			  $query_pro = "SELECT * FROM fs_company_project where company_id=".$_SESSION['fab_id']." order by project_title asc";
			 }else{
			  $query_pro = "SELECT * FROM fs_company_project where company_id=".$_SESSION['fab_id']." and skill LIKE '%".$_REQUEST['skill']."%' order by project_title asc";
...
<!-----add project here------------>
         <div class="slidediv">
							...
							<form enctype="multipart/form-data" onSubmit="return validate5();" name="upload_form" id="upload_form" action="" method="POST"  autocomplete="off" style="font:normal 13px arial;">
                                ...
                                <tr>
                                <td colspan="4" style="font-size:22px; text-align:center; color:#4FBFE3; border-bottom:1px #ccc solid; line-height:35px; font-weight:bold;">Add projects</td>	
                                </tr>
									...
									<table>
									  ...
									  <tr>
											<td width="150px" class="text_heading"><span class="style1">* Project Title</span> </td>
									  ...
									  <tr>
										<td width="150px" class="text_heading"><span class="style1">* Month/Year</span> </td>
									  ...
									  <tr>
											<td class="text_heading"><span class="style1">* Description</span> </td>
											<td colspan="2">
									  ...
									  <tr >				
											...
											<td colspan="2"><input style="color:#666;" type="file" name="files[]" id="files" multiple/>
											    <br/><span style="color:#666;font-size:12px;width:360px;">Here You Can Upload Multiple Images / Audio by holding Ctrl Key</span>
											</td>
									   ...
									   <tr>
										  ...
										  <tr >                      
												...
												<td width="150px" class="text_heading"> <span>Video Link<br />
												...
												<td colspan="2"><textarea id="video_link" name="video_link" cols="47" rows="4" class="input_area" style="width:500px;"></textarea><br>
													 <span style="color:#666;font-size:12px;width:360px;">( Separate Video Link By Comma Ex: Link1,Link2,Link3 )</span>
												</td>
										...
										<tr>
										   <td>&nbsp;</td>
											<td colspan="2" align="left">
												<input type="submit" id="submit"  name="submit" value="Create Project" class="register_create_ac" style="margin:0px; float:left;">
											</td>
										</tr>
								    </table>
								</form>
...
<!-----end add project here------------>
            ...
            <ul>
				...
				<?while($fatch_pro = f($run_pro)){ 
                  ...
                  $select_image = "select * from fs_company_project_portfolio where company_id='".$_SESSION['fab_id']."' AND project_id='".$fatch_pro['fld_id']."' AND (portfolio_data LIKE '%".$jpg."%' OR portfolio_data LIKE '%".$png."%' OR portfolio_data LIKE '%".$gif."%') limit 1";
			...
			if($counter==1){
            ?>
			<li><a href="company_project_details.php?id=<?=$fatch_pro['fld_id']?>">
            	<h2><?=$fatch_pro['project_title']?></h2>
            	<div class="mod_img" style="background:url('project_uploader_image/savefiles/<?=$fatch_image['portfolio_data']?>') no-repeat center;"></div>
