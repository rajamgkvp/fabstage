...
$sql_up="update fs_applied_job set company_request=1 WHERE company_id = '".$company_id."' AND job_id = '".$job_id."' AND talent_id = '".$talent_id."' ";
$res_up=q($sql_up);

echo $sql_delete = "DELETE FROM fs_company_reviews WHERE company_id = '".$company_id."' AND job_id = '".$job_id."' AND talent_id = '".$talent_id."' ";
...
$subject = 'FabSatge';
			...
			Your Job finish request has been rejected by Company..Kindly Communicate and try later..<br />
			<br />
			...
			if($mail){
				header('location:view_profile.php?id='.$job_id);
