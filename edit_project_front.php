...
if($_FILES['pic']['name'] != ""){	//UPLOAD LOGO
	...
	//LARGE PIC
	$uploaddir = 'admin/portfolio_project/';
	$input_name = 'pic';
	...
	if($file['error'] == UPLOAD_ERR_OK){
		if(isAllowedExtension($file['name'])){
			...
			$sql1 = "UPDATE fs_portfolio_project SET from1 = '".$_REQUEST['title']."', to1 = '".$_REQUEST['title1']."', des = '".$_REQUEST['des']."', doc = '".$uploadfile."' WHERE fld_id = '".$id."'";
	  ...
	  $sql1 = "UPDATE fs_portfolio_project SET from1 = '".$_REQUEST['title']."', to1 = '".$_REQUEST['title1']."', des = '".$_REQUEST['des']."' WHERE fld_id = '".$id."'";
...
//POPULATE 
$sql_pop = "SELECT * FROM fs_portfolio_project WHERE fld_id = '".$id."'";
$res_pop = q($sql_pop);
$row = f($res_pop);
?>
...
<form name="upload_form" action="" method="POST" onsubmit="return validate();">
 ...
 <table cellpadding="2" cellspacing="2">
		   <tr>
			  ...
			  <tr>
					<td width="150px"><span class="style1">*</span>&nbsp;<span class="text_heading">From Month/Year</span> </td>
			  ...
			  <tr>
			   ...
			   <tr>
					<td width="150px"><span class="style1">*</span>&nbsp;<span class="text_heading">To Month/Year</span> </td>
			  ...
			  <tr>
			   ...
			   <tr>
					<td width="150px"><span class="style1">*</span>&nbsp;<span class="text_heading">Browse  Project</span> </td>
			  ...
			  <tr>
			   ...
			   <tr>
				  <td>&nbsp;</td>
					<td>
					  <input type="submit" class="button" value="Edit Project" name="Submit">
				   </td>
				</tr>
		</table>
