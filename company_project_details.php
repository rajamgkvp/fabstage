...
$sqlg12 = "Select * from fs_company_project Where company_id = '".$id."' AND fld_id = '".$_REQUEST['id']."' ";
$resg12 = q($sqlg12);
$fatch12 = f($resg12);
...
<script>
       function delete_image(id){
	      if(confirm('Are you sure to delete this Image'))
	       window.location.href='delete_company_project_image.php?project_id='+id+'&id=<?=$_REQUEST['id']?>';
          }
...
<!------move image------------>
<script>
       function move_image(source,dest,fld_id,id){
	      
		  alert('dg');
		  if(confirm('Are you sure to Copy this image on gallery box'))
	       window.location.href='move_company_image.php?source='+source+'&dest='+dest+'&fld_id='+fld_id+'&id='+id;
          }
...
<!---black strip------->
        ...
        <div style="float:left; font-size:13px; color:#ccc; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:30px; padding-left:10px;"><a style="font-decoration:none;color:#ccc;" href="company_project.php">Projects</a> > <?=$fatch12['project_title']?></div>
	...
	<!------------>	
				...
				<div class="center_body" style="width:820px; clear:both;">
					...
					<table class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right; width:635px; background:#F5F5F5;">
			  ...
			  <tr>
					...
					<td colspan="3" width="72%" align="right" style="padding-right:15px;"><a style="padding-right:10px;"href="edit_company_project_files.php?project_id=<?=$_REQUEST['id']?>" rel="gb_page_center[600, 500]"><img src="images/add_icon.png" width="15" height="15" style="vertical-align:middle;" />  Add Files</a>
                    <a style="padding-right:10px;"href="edit_company_project.php?id=<?=$_REQUEST['id']?>" rel="gb_page_center[600, 500]"><img src="images/pencil_icon.png" width="15" height="15" style="vertical-align:middle;" /> edit</A></td>
                 ...
                 <tr>
					...
					<td colspan="3"><?=substr($fatch12['skill'],0,-1)?>	  </td>
			  ...
			  <tr>
					...
					<td colspan="3"><?=$fatch12['month_year']?>	 </td>
              ...
              <tr><td colspan="4" style="padding-left:14px; padding-right:10px; color:#6e6e6e; text-align:justify;"><?=$fatch12['description']?>	 </td></tr>
             ...
             <tr>
              ...
              <?
				  ...
				  $png = ".png";
				  $gif = ".gif";
			      $s = "select * from fs_company_project_portfolio where company_id='".$id."' AND project_id = '".$_REQUEST['id']."' AND(portfolio_data LIKE '%".$jpg."%' OR portfolio_data LIKE '%".$png."%' OR portfolio_data LIKE '%".$gif."%') ";
			      $q = q($s);
				  $nu = nr($q);
				  if($nu!=0){
			  ?>
...
<ul class="thumbnail-tabs">
			...
			<?
			  ...
			  while($f = f($q)){
			 $link = "company_project_uploader_image/savefiles/".$f['portfolio_data']."";
   ...
   <li>
				...
				<span class="img-title">
				 ...
				 <a href="move_company_image.php?source=<?=$link?>&dest=<?=$dest?>&fld_id=<?=$f['fld_id']?>&id=<?=$_REQUEST['id']?>" style="width:26px;"> 
				<!-- <a href="#" onClick="javascript:move_image(fdgd,dfg,5,5)" style="width:24px;"> --><img src="gallery/images/edit_icon.png" title="Move To Gallery" alt="Move To Gallery"></a>
                ...
                <a href="#" onClick="javascript:delete_image(<?=$f['fld_id']?>)" style="width:24px;"><img src="gallery/images/close_icon.png" title="Delete Image" alt="Delete Image"></a>
				</span>
	...
	<?
	          $mp3 = ".mp3";
			  $wav = ".wav";
	          $s = "select * from fs_company_project_portfolio where company_id='".$id."' AND project_id = '".$_REQUEST['id']."' AND (portfolio_data LIKE '%".$mp3."%' OR portfolio_data LIKE '%".$wav."%') ";
			  $q = q($s);
			  $num = f($q);
			  if($num!=0){
	?>
          ...
          <tr >
			...
			?>
			  ...
			  <tr>
		       ...
		       <td> <a  href="company_project_uploader_image/savefiles/<?=$f['portfolio_data']?>"><img src="images/mp3.png" alt="<?=$f['portfolio_data']?>" width="120" height="120"></a></td>
...
<!---------video ---------->
   ...
   <?
              $s = "select * from fs_company_project_video_link where company_id='".$id."' AND project_id = '".$_REQUEST['id']."'";
			  $q = q($s);
              $c = nr($q);
			  if($c!=0){
   ?>
