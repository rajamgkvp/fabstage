...
function upload_multiple_file($file,$file_dir="company_project_uploader_image/savefiles/") {
 ...
 if(isset($_FILES['files'])){
    ...
    echo $res;
                  ...
                  if($_REQUEST['video_link']!=''){
								 ...
								 $video = explode(",",$video_link);
									foreach ($video as &$link) {
									   $Insert = "insert into fs_company_project_video_link(company_id,project_id,video_link,added_on)values('".$_SESSION['fab_id']."','".$_REQUEST['project_id']."','".$link."','".date('Y-m-d h:i:s')."') ";
		...
		//
            ...
            //project_details.php?id=43
				...
				header('location:company_project_details.php?id='.$_REQUEST['project_id'].'');
	...
	$sqlg = "Select * from fs_company_project Where company_id = '".$_SESSION['fab_id']."' AND fld_id = '".$_REQUEST['project_id']."' ";
	$resg = q($sqlg);
	$fatch11 = f($resg);
	...
	<!------------>	
				...
				<div class="center_body" style="width:820px;">
					...
					<table class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right; width:605px;">
						...
						<tr>
                        <td style="font-size:22px; text-align:center; color:#4FBFE3; border-bottom:1px #ccc solid; line-height:35px; font-weight:bold;" colspan="4">Add More Files</td>
                        </tr>
									  ...
									  <tr >				
									   ...
									   <tr>
										  ...
										  <tr >                      
												...
												<td width="150px" class="text_heading">Video Link<br />
(Youtube Video)</td>
										...
										<tr>
										   <td>&nbsp;</td>
											<td colspan="2" align="left">
												<input class="register_create_ac" style="margin:0px; float:left;" type="submit" id="submit"  name="submit" value="Add Files" >
											</td>
										</tr>
								    </table>
								</form>
