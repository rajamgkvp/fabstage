<?php
	...
	if(isset($_REQUEST['wages']) && $_REQUEST['wages'] != ''){
		...
		$sql = "UPDATE fs_oudition_details SET 
		...
		breast_chest = '".$_REQUEST['breast_chest']."', 
...
<?php
	//POPULATE 
	$sql_pop = "SELECT * FROM fs_oudition_details WHERE fld_id = ".$id."";
	$res_pop = q($sql_pop);
	$row = f($res_pop);
?>
	...
	<form name="upload_form" id="upload_form" action="" method="POST" onsubmit="return validate();" autocomplete="off">
		<table width="90%"  border="0" align="center" cellspacing="1" cellpadding="1">
			...
			<tr>
				...
				<td><input class="input" name="requirement" value="<?=$row['requirement']?>" type="text" id="requirement" size="48" ></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td><input class="input" name="job_role" value="<?=$row['job_role']?>" type="text" id="job_role" size="48" ></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>
					<input class="input" name="association_name" value="<?=$row['association_name']?>" <?if($row['any_association']=="no"){?>disabled<?}?> type="text" id="association_name" size="48" >
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<!-- <tr>
				...
				<td><input class="input" name="measurement" value="<?=$row['measurement']?>" <?if($row['physical_preference']=="no"){?>disabled<?}?> type="text" id="measurement" size="48" ></td>
			</tr> -->
  ...
  <tr>
   ...
   <tr>
    ...
    <td><select id="bust_chest" name="bust_chest" style="width:85px;">
				  ...
				  ?> 
				  <option value="<?=$bust_chest_fatch['type']?>" <?if($row['breast_chest']==$bust_chest_fatch['type']){?>selected<?}?>><?=$bust_chest_fatch['type']?></option>
				  <?}?>
       </select>
  ...
  <!-- <tr>
    ...
    <td><input class="input" name="look" value="<?=$row['look']?>" <?if($row['physical_preference']=="no"){?>disabled<?}?> type="text" id="look" size="48" ></td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>
					<input type="submit" id="submit" value = "Edit Oudition Details" name="Submit">
				</td>
			</tr>
			<tr>
				<td height="40px">&nbsp;</td>
