...
<table width="100%">
  <tr>
    <td valign="top" style="height:370px; width:1000px;background:url('images/main_banner.jpg') left top no-repeat;">
	      ...
	      <div class="slidediv" style="float:right;clear:both;">
						  ...
						  <form name="upload_form" action="" method="POST" onSubmit="return validate();" enctype="multipart/form-data" autocomplete="off">
												<table cellpadding="2" cellspacing="2">
													   ...
													   <tr>
															<td width="150px"><span class="style1">*</span>&nbsp;<span>Browse Banner</span> </td>
					...
					<?
		                ...
		                $skill = explode(",",$main_skill);
						  foreach ($skill as &$value) {
				                      ...
				                      $sql_match = "SELECT DISTINCT member_id FROM fs_company WHERE main_skill LIKE '%".$value."%'  AND member_id != '".$_SESSION['fab_id']."' order by member_id DESC "; 
