...
//POPULATE 
$sql_pop = "SELECT * FROM fs_sub_category WHERE fld_id = ".$_REQUEST['id']."";
$res_pop = q($sql_pop);
$row = f($res_pop);


$sql_duplicate = "SELECT * FROM fs_category WHERE fld_id = '".$row['category_id']."'";
...
<form name="upload_form" action="" method="POST" onsubmit="return validate();">
 ...
 <table width="100%" border="0" align="center" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td colspan="2" align="center" class="contentheading">Sub Category Details</td>
  </tr>
  <tr>
    <td colspan="2" height="8"></td>
  </tr>
  <tr>
    <td width="120px"><span><b>Category Type:</b></span></td>
    <td>
		 <?=$category_name?>
	 </td>
  </tr>
