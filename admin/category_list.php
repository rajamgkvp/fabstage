...
<p><h3>Add Category <a href="add_category.php" title="Add Category" rel="gb_page_center[540, 520]" style="cursor: pointer;">Click Here</a></h3></p>
...
$comm=q("SELECT * FROM fs_category ORDER BY `fld_id` DESC");
if(nr($comm) > 0)
{
$paging=new paging(25,5);
$paging->query("SELECT * FROM fs_category ORDER BY `fld_id` DESC");
$page=$paging->print_info();
	...
	<tr align="right" bgcolor="<?=$color?>">
		...
		<td><a href="edit_category.php?id=<?=$rec_mem['fld_id']?>" title="Edit Category" rel="gb_page_center[800, 300]" style="cursor: pointer;"><img src="admin_img/edit.png" border="0"></a></td>
