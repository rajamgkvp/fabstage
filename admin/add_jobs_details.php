...
<tr>
  ...
  <td>&nbsp;</td>
    <td>
      <input type="submit" id="submit" value = "Add Job Details" name="Submit">
   </td>
    </tr>
      <tr>
    <td height="40px">&nbsp;</td>
