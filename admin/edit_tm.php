...
if($_REQUEST['rname'] !=''){
	$sql = "UPDATE fs_testimonials SET name = '".$_REQUEST['rname']."',  comment = '".htmlEntities($_REQUEST['desc1'])."' Where fld_id = '".$_REQUEST['id']."'";
	$res = q($sql);
	$msg = " - Testimonials has been Updated successfully.";
}
$sql = "Select * from fs_testimonials Where fld_id = ".$_REQUEST['id']."";
$res = q($sql);
$row = f($res);
?>
			...
			<tbody>
				<tr>
				 <td colspan="2"  align="left">
					<table cellpadding="0">
						<tr><td style="color: #008040;font-size: 18px; font-family: arial "> Edit Testimonials</td>
						</tr>		
					</table>
				</tr>
				<?
			 ...
			 <tr>
              ...
              <tr>
               <td align="left" width="80px" style="color: #333333; font-weight: bold;">comments <span style="color:red"><b>*</b></span></td>
              
                <td ><textarea rows="10" cols="40" name="desc1" id="desc1"><?=$row['comment']?></textarea> </td>
              </tr>
