<? include('constants.php');
   ...
   if(isset($_REQUEST['submit'])){
				   ...
				   for($j=0;$j<count($_REQUEST['cat']);$j++)
					...
					$query="UPDATE fs_company SET main_skill='".$check_val."', other1='".$_REQUEST['other1']."',other2='".$_REQUEST['other2']."',other3='".$_REQUEST['other3']."',other4='".$_REQUEST['other4']."' WHERE email='".$_SESSION['email']."'";
	                $run=q($query);
					if($run){
