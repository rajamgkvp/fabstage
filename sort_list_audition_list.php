...
function reject(j_id,t_id){

 var retVal = confirm("Do you want to reject this offer ?"); 
 if(retVal == true ){
          window.location.href="delete_audition_details.php?jobid="+j_id+"&talentid="+t_id;
         return true;
 }else{
			//alert("Thank You");
			return false;
						...
						<table class="center_body" width="100%"  border="0" align="right" cellspacing="1" cellpadding="1" style="float:right; margin-top:0px;">
							<tr>
                                ...
                                <div class="jobs_tabing">
                                	<ul>
                                    	<li><a href="sort_list_job_list.php?tab=5" >Job </a></li>
                                        <li><a href="sort_list_audition_list.php?tab=5" class="active">Audition </a></li>
                                    </ul>
                                </div>
                                </td>
                            </tr>
                          ...
                          <tr>
							...
							<!--------------->
								...
								<td width="30%">
									...
									<div class="reject_btn"><div class="accept_btn"><a href="#" onclick="reject(<?=$job_result['audation_id']?>,<?=$job_result['talent_id']?>);" >Reject</a></div> 
									
									<a href="#" nclick="getConfirmation(<?=$job_result['audation_id']?>,<?=$job_result['talent_id']?>);">Accept</a></div>
