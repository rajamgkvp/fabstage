...
error_reporting(0);
	$status_query = q("UPDATE fs_applied_job SET status=3
					WHERE job_id='".$_REQUEST['jobid']."' AND talent_id='".$_REQUEST['talentid']."'");
	...
	//QUERY TO GET TALENT EMAIL ADDRESS
	$company = "SELECT * FROM fs_applied_job WHERE job_id = '".$_REQUEST['jobid']."' AND talent_id = '".$_REQUEST['talentid']."'";
...
<script type="text/javascript">
		window.location.href="sort_list_job_list.php";
</script>