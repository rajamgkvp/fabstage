...
include('check_session.php');	
	...
	if(isset($_REQUEST['title']) && $_REQUEST['title'] != '') {
		$sql_admin = "INSERT INTO fs_job(company_id,title,category, sub_category, description, interview_venue, interview_date, interview_time,contact_person,contact_number,contact_email,web_link, agencies_applies,expire_date,sponser,added_on)VALUES
		('".$_SESSION['fld_id']."','".$_REQUEST['title']."', '".$_REQUEST['category']."', '".$_REQUEST['sub_category']."', '".$_REQUEST['description']."', '".$_REQUEST['interview_venue']."', '".$_REQUEST['interview_date']."', '".$_REQUEST['interview_time']."','".$_REQUEST['contact_person']."','".$_REQUEST['contact_number']."', '".$_REQUEST['contact_email']."','".$_REQUEST['web_link']."','".$_REQUEST['agencies_applies']."', '".$_REQUEST['expire_date']."','".$_REQUEST['sponser']."',
		'".date('Y-m-d h:m:s')."')";
