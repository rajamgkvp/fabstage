<?php
   ...
   if(isset($_REQUEST['submit'])){
		$query = "INSERT INTO fs_audition_msg(audition_id,sender_id, 
		receiver_id,message,send_time)VALUES('".$_REQUEST['audition_id']."',
		'".$_SESSION['fab_id']."','".$_REQUEST['company_id']."',
		'".$_REQUEST['message']."','".date('Y-m-d h:i:s')."')";
		$insert = q($query);
		if($insert){
