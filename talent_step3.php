<? include('constants.php');
   ...
   if(isset($_REQUEST['submit'])){
                ...
                $query="UPDATE fs_talent SET height='".$_REQUEST['height']."', weight='".$_REQUEST['weight']."',bust_chest = '".$_REQUEST['bust_chest']."',waist ='".$_REQUEST['waist']."',hips = '".$_REQUEST['hips']."',
				
				ethenicity='".$_REQUEST['ethenicity']."',eye='".$_REQUEST['eye']."',hair='".$_REQUEST['hair']."',body='".$_REQUEST['body']."',skin='".$_REQUEST['skin']."',shoes='".$_REQUEST['shoes']."',dress='".$_REQUEST['dress']."',look='".$_REQUEST['look']."' WHERE member_id='".$_SESSION['fab_id']."'";
	                $run=q($query);
					if($run){
		...
		<form name="upload_form" action="" method="POST"  autocomplete="off" style="font:normal 13px arial;">
						...
						<td>
						  ...
						  <tr>
							...
							<td style="font-size:14px;color:#669966; text-transform:capitalize; ">Brest/Chest &nbsp;&nbsp;&nbsp;&nbsp;Waist &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hips</td>
						  </tr>
						  <tr>
