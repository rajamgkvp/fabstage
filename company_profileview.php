...
$id=$_REQUEST['company_id'];
	    ...
	    $query1 = "select * from fs_company where member_id='".$id."'";
		$run1 =   q($query1);
		$count1 = nr($run1);
		$fatch1 = f($run1);
...
//CHECK DATE VALIDATION / OLD DATE
    function getlike(id1) {		
    	...
    	var strURL='get_like_company.php?id1='+id1+'&tid=<?=$_REQUEST['company_id']?>';
		var req = getXMLHTTP();
		//alert(strURL);
		if (req) {
...
<div id="main_container">
    ...
    <div style="margin:0px auto; width:1000px;"><img src="images/main_banner.jpg" width="1000" height="370" /></div>
  ...
  <div class="profile_body">
        	<div class="profile_left_area">
              ...
              <div style="float:left; width:auto;"><img src="images/nbc_logo.jpg" width="70" height="70" /></div>
   ...
   <div id="tcontent2" class="tabcontent">
		...
		myflowers.init()
          ...
          <div class="profile_right_area" style="margin-top:55px;">
				...
				<?
				$sqll="select * from fs_company_likes where company_id='".$id."'";
				$resl=q($sqll);
				$countl=nr($resl);
				$rowl=f($resl);
				if($countl>0){
					...
					<?
		                ...
		                $skill = explode(",",$main_skill);
						  foreach ($skill as &$value) {
				                      ...
				                      $sql_match = "SELECT DISTINCT member_id FROM fs_company WHERE main_skill LIKE '%".$value."%'  AND member_id != '".$id."' order by member_id DESC "; 
								 ...
								 //echo $array1;
									...
									foreach ($red_array1 as &$value11) { 
									  ...
									  ?>
										...
										<li>
												  <img src="admin/portfolio_talent_pic/<?=$fatch_q_u_q1['large_pic']?>" width="51" height="51" /> 
