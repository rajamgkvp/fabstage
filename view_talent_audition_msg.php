...
<html>
	<body>
	   <div style="background:#669966; padding:5px;"> 
		...
		<?php
		   $title_query11 = q("SELECT * FROM  fs_audition_msg WHERE (sender_id='".$_SESSION['fab_id']."' OR sender_id='".$_REQUEST['company_id']."') AND (receiver_id='".$_SESSION['fab_id']."' OR receiver_id='".$_REQUEST['company_id']."') AND audition_id = '".$_REQUEST['audition_id']."' order by fld_id DESC ");
		?>
		<table width="100%"  border="0" align="center" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="text_heading"><?=$quer_fatch['send_time']?></td>
			</tr>
			<?}?>
		</table>
	 </body>
