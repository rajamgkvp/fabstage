...

{
   ...
   if ( $_SESSION['security_code'] == $_REQUEST['captcha']) 
	
	{
					...
					$sqls = "INSERT INTO fs_help (name,email,mobile,question,added_on)VALUES ('".$_REQUEST['nam']."','".$_REQUEST['email']."','".$_REQUEST['cont']."','".$_REQUEST['msg']."','".date('Y-m-d h:m:s')."') ";
					$ress = q($sqls);
	    ...
	    $msg1 = '<span style="font-size:12px;font-family:arial;color:#006633"><b>Your Quiestion Successully Send.</b></span>';
...
<script language="javascript" type="text/javascript">
 function validatequiry(){
	...
	if(document.enquiryform.msg.value == ""){
		 errText = "Please Enter Your Question.";
		 alert(errText);
			...
			<div>
				<div class="main_body_area">
					...
					<div class="center_body" style="width:800px;">
						...
						<table class="center_body" style="width:760px"  border="0" align="right" cellspacing="1" cellpadding="1" style="margin-top:0px;float:right;">
							...
							<tr>
								<td colspan="3"  style="font-size:16px;font-weight:bold;font-family:arial;color:#3B8EBA">
									Generally Asked Question And Answers List
								</td>
							</tr>
                            <tr>
					 ...
					 $select_testi = q("select * from fs_help where answer!='' ".$limit);
							...
							?>
							<tr>
						<td class="colorrr" style="color:#cc0000;font-size:14px;font-weight:bold;"><?=ucwords($fatch_testi['question'])?>
							...
							<tr>
								<td style="border-bottom:1px #999 dotted;padding-bottom:5px;" colspan="2"><?=$fatch_testi['answer']?>
                ...
                <tr>
                    <td height="10px" style="color: #B00000">
                                            <?
                                             $sqlag = "SELECT * FROM fs_help";
                                       
                                                $rescs = q($sqlag);
                                                 $countcs = nr($rescs);
                                                if($countcs >10){
                                                    doPages(10, 'help.php', '', $countcs); 
                                                }
                                            ?>
                    </td>
                </tr>
                ...
                <tr bgcolor="#CCCCFF">
                      <td style="font-family:arial;padding:5px 5px 5px 5px"><span style="font-size:14px;font-family:arial"><b>Any Question not found....</b></span></td>
                </tr>
                                ...
                                <td class="enquiry_bg" valign="top">
									<form name="enquiryform" action="" onsubmit="return validatequiry();" method="POST" enctype="">
                                    	...
                                    	<table width="500" border="0" cellspacing="6" cellpadding="0">
                                          <tr><td class="heading" colspan="2" style="font-size:16px;font-weight:bold;font-family:arial;color:#3B8EBA">Submit Your Question</td></tr>
										  <tr>
                                          ...
                                          <tr>	
                                          	<td class="form_text" style="font-size:14px;font-family:arial">Question:</td>
